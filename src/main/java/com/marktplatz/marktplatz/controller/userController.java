...
public class userController <T> {
    ...
    @GetMapping("/getAll")
    public ResponseEntity<T> getAllUser(){return  ResponseEntity.ok((T) userService.getAllUser().getBody());}
    ...
    @PostMapping("/addUser")
    public ResponseEntity<T> addUser(@RequestBody User user){return ResponseEntity.ok((T)userService.addUser(user).getBody());}
